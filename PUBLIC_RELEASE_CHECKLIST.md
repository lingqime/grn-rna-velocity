...
- [x] Canonical scripts contain no machine-specific `/home/featurize/...` paths.
...
- [ ] Choose a software license and add `LICENSE`.
- [ ] Confirm the manuscript author list and add `CITATION.cff`.
...
Do not mark the repository Public until the unchecked metadata items that matter
for the intended release have been resolved.
